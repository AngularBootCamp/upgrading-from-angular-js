# Angular Boot Camp example: upgrading-from-angular-js
...
**[StackBlitz for upgrading-from-angular-js](https://stackblitz.io/github/AngularBootCamp/upgrading-from-angular-js)**

Alternatively, you can clone the repository locally to run the example:

```
git clone git@github.com:AngularBootCamp/upgrading-from-angular-js.git
cd upgrading-from-angular-js
npm install
npm start
```
